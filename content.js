...
const prompt = [
  ...
  "For Itau/Itaú receipts with sections de and para, payer_name is the bold company/person immediately under de. Do not skip it because the section label is short.",
